...
- 	itulo: Nome da tarefa
- descricao: Descrição detalhada
- esponsavel_id: ID do usuário responsável
- esponsavel_nome: Nome do responsável
- prazo: Data limite (formato DD/MM/AAAA)
- status: Estado (Pendente, Concluída, Atrasada)
- criacao: Data e hora de criação
...
- 	ela_cadastro() - Interface de cadastro de usuários
- 	ela_login() - Interface de login
- 	ela_criar_tarefa() - Interface para criar nova tarefa
- 	ela_editar_tarefa() - Interface para editar tarefa existente
...
- utenticar_usuario(login, senha) - Realiza login do usuário
